    ...
    return (
        ...
        >
            ...
            <Modal.Body>
                ...
                {(!answer.estado) && (
                    <>
                        <label className="" htmlFor="">Tú mascota respuesta.</label>
                        <textarea className="form-control" disabled={true} name="nombre" placeholder={`Respuesta`} value={answer.nombre} onChange={({ target }) => onChange(target)} />
                    </>
                )}
            </Modal.Body>
            <Modal.Footer>
